...
def crear_asignatura_programa(client, db_session):
    # Mock del usuario para la prueba
    usuario_prueba = {
        "user_id": 1,
    ...
    assert horario_response.status_code == 201
    horario_id = horario_response.json()["id"]
    
    # Crear asignatura_programa directamente en la base de datos
    ...
    # Crear salon directamente en la base de datos
